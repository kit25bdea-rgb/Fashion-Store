...
The website delivers a clean and modern shopping experience — users can browse featured items, search products, shop by gender category (Men's / Women's), manage a live shopping cart, and contact the store, all on a single scrollable page.
...
|---|---|---|
| Classic T-Shirt | Men's | $29.99 |
| Premium Hoodie | Men's | $59.99 |
| Slim Fit Jeans | Men's | $49.99 |
| Leather Jacket | Men's | $129.99 |
| Floral Dress | Women's | $79.99 |
| Running Sneakers | Both | $89.99 |
...
- **Bootstrap 5.3** — Grid system, navbar, carousel, cards, buttons, alerts
- **Bootstrap Icons** — Cart, trash, social media, and contact icons
- **JavaScript (ES5/ES6)** — Product rendering, cart logic, search, form validation
...
├── script.js        # Product data, cart logic, search, form validation
└── README.md        # This file
```
...
1. Clone the repository:
   ```bash
   git clone https://github.com/kit25bdea-rgb/Fashion-Store.git
   ```
...
*Fashion Store · Good quality clothes for everyone.*
